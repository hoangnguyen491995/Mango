        ...
        return /*#__PURE__*/ _react.default.createElement(
          ...
          resources.map(function (_ref, idx) {
            var _ref2 = (0, _slicedToArray2.default)(_ref, 2),
              id = _ref2[0],
              resource = _ref2[1];
            let title = accessors.resourceTitle(resource);
            let checkFailImage = false;
            var url = `https://uat-manage.enrichcous.com:4443/Upload/Employee/${resource.imageFileName}`;
        
   
          // checkFailImage = ImageExists(url)
          checkFailImage = false

            const avatarStyle = {
              padding: 8,
              backgroundImage: `url("https://uat-manage.enrichcous.com:4443/Upload/Employee/${resource.imageFileName}")`,
              backgroundPosition: "center",
            ...
            let left = minWid*idx+81;      
           return /*#__PURE__*/ _react.default.createElement(
              "div",
              {
                id: idx ,
                className: resource.type == "Salon" ? "rbc-salon-appointment rbc-time-header-content" : "rbc-time-header-content rbc-header-tech",  
                style: { 
                  maxWidth: 140, 
                  minWidth: 140, 
                  width: 140,
                  left: resource.type == "Salon" && `${left}px`,
                } ,
                key: id || idx,
              },
                  ...
                  _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                      ...
                      /*#__PURE__*/ _react.default.createElement(
                        ...
                        {
                          index: idx,
                          label: checkFailImage ? "" : title.charAt(0),
                          resource: resource,
                        }
                      ),
                       /*#__PURE__*/ _react.default.createElement(
             ...
             /*#__PURE__*/ _react.default.createElement(
                "input",
                {
                // value:   localStorage.getItem(resource.resourceId),
                onChange: onChangeHandler,
                onBlur: (()=>onBlurHandler(resource.resourceId)),
                 type: "text",
                 placeholder:  localStorage.getItem(resource.resourceId) 
                 || title ,
