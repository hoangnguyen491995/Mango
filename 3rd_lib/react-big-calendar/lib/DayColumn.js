  ...
  function DayColumn(index) {
    ...
    _this.renderEvents = function (_ref) {
      ...
      var _this$props = _this.props,
        ...
        handleClickTicket = _this$props.handleClickTicketFunc;
      ...
      return styledEvents.map(function (_ref2, idx) {
        ...
        return /*#__PURE__*/ _react.default.createElement(
          _TimeGridEvent.default,
          {
            ...
            // handleClickTicket: handleClickTicket(event.appointmentId, e),
            ...
            onClick: function onClick(e) {
              ...
              return handleClickTicket(payload);
              //return _this._select(e);
            },
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (resourceItem != null) {
          resourceItem.map(function (value, idx) {
        ...
        if(this.state.timeIndicatorPosition){
          topPositionTimeLine = this.state.timeIndicatorPosition;
        }
        ...
        return /*#__PURE__*/ _react.default.createElement(
          DayColumnWrapperComponent,
          {
            ...
            date: date,
            style : typeTech =="Salon" ? styled : style,
            id: index,
...
DayColumn.defaultProps = {
  ...
  timeslots: 2,
  timeIndicatorPosition: topPositionTimeLine,
};
