  ...
  return (
    <div className="flex justify-between">
      ...
      {listCustomerGallery.map((e, index) => (
        <div className="upload-img customer-gallery-list-item mr-3" key={index} onClick={showModalAlBums}>
          <img
            className="mr-1 "
      ...
      <AlbumsPhotos
        ...
        customerId={customerId}
        imageUpload={imageUpload}
        listCustomerGallery = {listCustomerGallery}
        onChange1 = {onChange1}
      />
    </div>
  );
