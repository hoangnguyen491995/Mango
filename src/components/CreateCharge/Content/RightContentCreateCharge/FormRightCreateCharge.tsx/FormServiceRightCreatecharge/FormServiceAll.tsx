...
import { setApptId, setCheckNo } from "src/components/CreateCharge/createcharge-slice";
...
function OpenTicketAll({ all1 }: any) {
  const [posts, setPosts] = useState<IPosts[]>([]);
  useEffect(() => {
    setPosts(all1 as IPosts[]);
  }, [all1]);
              ...
              <Col
                onClick={(e) => {
                  if (post.customerID != 0) {
                    ...
                    dispatch(
                      CreateChargeSlice.actions.showLeftAddTechRender(
                        Math.random()
                      )
                    );
                  } else {
                  ...
                  dispatch(setCheckNo(post.checkNo))
                  dispatch(setApptId(post.originalAppointmentID))
                  dispatch(
                ...
                <Row className="flex flex-col items-center mt-2 mb-[3px]">
                  <Col span={4} className="mr-[2px]">
                    <div
                      ...
                      className="w-[32] h-[25px] rounded-r-2xl  "
                    >
                    ...
                    <Row>
                      ...
                      <Col span={24}>
                        <div className="flex justify-start">
                          <span className=" text-xs">{post.customerType}</span>
                        </div>
                      </Col>
                    </Row>
                  </Col>
                  ...
                  <Col span={24} className="ml-[3px] mt-[10px]">
                    <div className="flex flex-col justify-start ">
                      {post.groupEmployeeDetail == "" ? (
                        ...
                        <div className=" flex justify-start ">
                          <button
                            className="max-w-[120px] px-4 rounded h-[30px] truncate mt-2 shadow-md mr-[2px] text-white font-semibold"
                            style={{
                              background: `${
