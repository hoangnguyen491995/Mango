...
const ModalScanCoupon: React.FC = () => {
  ...
  return (
    <>
      <span
        onClick={showModal}
        className="font-bold  py-3 px-2 flex justify-start border rounded text-base flex-col"
        style={{
      ...
      >
        <span>COUPON</span>
        <span style={{ letterSpacing: "-0.3px", color: "#D1D1D1" }}>$0</span>
      </span>
      ...
      >
        ...
        <Row className="flex justify-center content-center items-center mt-2">
          ...
          <Col span={21}>
            <button
              className="w-full mt-2 rounded py-[4px] font-bold text-lg"
              style={{
...
export default ModalScanCoupon;
